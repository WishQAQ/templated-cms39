...
class ListView
{
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."PageNo=$prepagenum".$pageaddurl."'>上一页</a>\r\n";
            $indexpage="<a href='".$purl."PageNo=1".$pageaddurl."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a>首页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".$purl."PageNo=$nextpagenum".$pageaddurl."'>下一页</a>\r\n";
            $endpage="<a href='".$purl."PageNo=$totalpage".$pageaddurl."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a>末页</a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a href='".$purl."PageNo=$j".$pageaddurl."'>".$j."</a>\r\n";
            }
        }
